        ...
        <div class="p-2 rounded-lg bg-custom-green-100 shadow-lg sm:p-3">
            <div class="md:flex items-center justify-between flex-wrap">
                ...
                <div class="order-3 mt-8 flex-shrink-0 w-full sm:order-2 sm:mt-0 md:w-auto">
                    <button class="flex mx-auto items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-custom-green-100 bg-white hover:bg-custom-green-200 focus:outline-none js-cookie-consent-agree cookie-consent__agree">
