<x-guest-layout>
    <div class="mx-4 md:mx-8">
        <article class="max-w-7xl mx-auto mt-20 mb-20">
            <h1 class="text-center font-bold text-xl md:text-4xl">@lang('See all of our articles')</h1>
            <h2 class="text-center text-gray-400 text-lg md:text-2xl">@lang('Missing a topic? Feel free to request it')</h2>
